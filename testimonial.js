        ...
        <div className="row">
          <div className="col">
            ...
            <p style={{ fontWeight: "lighter" }}>
              ...
              Medical Press What Patient say About Medical Press
            </p>
            <div
            ...
            <div style={{ padding: "100px" }}>
              <p style={{ fontSize: "20px", fontWeight: "lighter" }}>
                ...
                say About Medical Press What Patient say About Medical Press
                What Patient say About Medical Press
              </p>
              <div>
                <h3>Marina Forrest</h3>
                <hr />
                <p style={{ fontWeight: "lighter" }}>Automatic</p>
              </div>
            </div>
          </div>
        </div>
